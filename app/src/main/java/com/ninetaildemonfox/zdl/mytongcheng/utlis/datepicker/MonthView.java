package com.ninetaildemonfox.zdl.mytongcheng.utlis.datepicker;
...
public class MonthView extends View {
    ...
    private void draw(Canvas canvas, Rect rect, DPInfo info) {
        ...
        drawT(canvas, rect, info);
        drawGregorian(canvas, rect, info.strG, info.isWeekend,info.isToday,info,day);
        if (isFestivalDisplay) {
            drawFestival(canvas, rect, info.strF, info.isToday);
        }
...
//            drawBGToday(canvas, rect);
    ...
    private void drawT(Canvas canvas, Rect rect, DPInfo info) {
        if (null != mDPDecor && info.isDecorT) {
//            LogUtils.e("drawBG===="+info.strG);
            mDPDecor.drawDecorT(canvas, rect, mPaint,
                    centerYear + "-" + centerMonth + "-" + info.strG);
        }
        if (info.isToday && isTodayDisplay) {
//            drawBGToday(canvas, rect);
    ...
    private void drawGregorian(Canvas canvas, Rect rect, String str, boolean isWeekend,boolean isToday,DPInfo info,String day) {

//        LogUtils.e("drawGregorian====" + str);
//        LogUtils.e("getSelDatLIst====" + mCManager.getSelDateList().toString());

//        mPaint.setColor(isToday? Color.GRAY:Color.RED);
        mPaint.setColor(isToday? Color.GRAY: getResources().getColor(R.color.text_gray_color));
        mPaint.setTextSize(sizeTextGregorian);
//        if (isWeekend) {
...
//            mPaint.setColor(Color.RED);
            ...
            if(TextUtils.isEmpty(day)||TextUtils.isEmpty(info.strG)){

            }else{
                if(Integer.parseInt(info.strG)<Integer.parseInt(day)){
